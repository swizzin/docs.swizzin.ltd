...
#### Migration
If you've got an older install and just want to move it, follow standard install procedures. Install all apps, then stop the services and run the following command. 
