...
Did you install the `quota` package? You need to use the (setquota)[/scripts/setquota] script to define the limits per user. The default quota is undefined, which is the source of this error.
