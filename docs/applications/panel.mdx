...
Finally, if you want to add an application icon to the sidebar, simply add a similarly named .png (or use the `img` variable) to the `/opt/swizzin/static/img/brands` folder. i.e. `/opt/swizzin/static/img/brands/radarr4k.png`.
