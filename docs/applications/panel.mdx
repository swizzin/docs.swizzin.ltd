...
- `NETWORK_TOTALS` - Display a additional column in the network widget with up/down transfers added together
...
You have not installed the panel -- this behavior is working as intended. Install the panel and this error will be replaced by a login prompt
