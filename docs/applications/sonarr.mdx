...
You can upgrade to Sonarr v3 by running either `box install sonarrv3` or `box upgrade sonarr` (They do the exact same thing). Please check [the migration chapter](/docs/applications/sonarrv3#migrating-from-v2) for more information.

### Downgrading from Sonarr v3
Like above, please check [the downgrading chapter](/docs/applications/sonarrv3#downgrading-to-v2) in v3 docs for more information.
