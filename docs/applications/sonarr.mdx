...
<Tabs
  ...
  <TabItem value="start"><CodeSnippet code="sudo systemctl start sonarr@<username>" lang="bash"></CodeSnippet></TabItem>
  <TabItem value="stop"><CodeSnippet code="sudo systemctl stop sonarr@<username>" lang="bash"></CodeSnippet></TabItem>
  <TabItem value="restart"><CodeSnippet code="sudo systemctl restart sonarr@<username>" lang="bash"></CodeSnippet></TabItem>
  <TabItem value="enable"><CodeSnippet code="sudo systemctl enable sonarr@<username>" lang="bash"></CodeSnippet></TabItem>
  <TabItem value="disable"><CodeSnippet code="sudo systemctl disable sonarr@<username>" lang="bash"></CodeSnippet></TabItem>
</Tabs>
...
SSL: OFF" lang="plaintext"></CodeSnippet></TabItem>
  <TabItem value="enable"><CodeSnippet code="NZBget host: 127.0.0.1
port: 443
URL Base: nzbget
